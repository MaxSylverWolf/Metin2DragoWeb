...
<center><form action="?action=register" method="post">
	...
	Powtórz Has³o: <input type="password" name="rpt_passwd"><br>
	Kod usuniêcia postaci: <input type="text" name="social_id" maxlength="7" size="7"><br>	
	<input type="submit" value="Zarejestruj!">
</form></center>
<?php
/************ KONFIGURACJA KOMUNIKATÓW *******************/
$message['success'] = "Konto zosta³o pomyœlnie za³o¿one!"; 
